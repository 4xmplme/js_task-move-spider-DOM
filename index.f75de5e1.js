...
const { offsetLeft: wallOffsetX, offsetTop: wallOffsetY, clientLeft: wallBorderLeft, clientTop: wallBorderTop, clientWidth: wallWidth, clientHeight: wallHeight } = wall;
